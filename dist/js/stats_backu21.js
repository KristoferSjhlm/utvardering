    ...
    'use strict';
        ...
        _.when(ds.fetch()).then(function() {
            ...
            document.getElementById('classes').innerHTML = "Klass: " + klassString;
                ...
                console.log("Classes-data " + classes.column('Klass').data[0]);
                /*
                ...
                */
                ...
                //for (var i = 0; i < 1; i++) {
                    ...
                    //className[0] = classes.column('Klass').data[0];
                    ...
                    console.log(className.length, className.toJSON());



                    // start from here. Get the url parameter function from evalutate.

                    classLessons[0] = className.countBy('Lektionsmal');

                    
                    for (var j = 0; j < classLessons[0].length; j++) {
                        ...
                        classNameLessons[counter] = className.where({
                            ...
                            // and only where the values are > 1
                            rows: function(row) {
                                return row.Lektionsmal == classLessons[0].column('Lektionsmal').data[j]
                            }
                        });
                ...
                //console.log(classNameLessons[0].length);
                //console.log(classNameLessons[0]);
                //console.log("data " + classNameLessons[0].countBy("Maluppfyllnad").toJSON());
                /*
